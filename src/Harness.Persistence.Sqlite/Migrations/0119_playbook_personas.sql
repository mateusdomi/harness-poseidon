...
ALTER TABLE agent_definitions ADD COLUMN activation_criteria_json TEXT NOT NULL DEFAULT '[]';
ALTER TABLE agent_definitions ADD COLUMN non_activation_criteria_json TEXT NOT NULL DEFAULT '[]';
