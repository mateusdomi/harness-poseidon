...
Atualizado em: 2026-07-18T15:59:52Z

## Retomada rápida

- Fase atual: Fase 1 — Fundação determinística; GNG-1 verde com 9/9 PoCs.
- Épico atual: EP-10b.2b.2 — lifecycle transacional de WorkflowRun; inicialização atômica do run está verde.
- Branch obrigatória: `develop`.
- Último commit remoto validado: `d0fc37d` (`develop`); inicialização EP-10b.2b.1 está verde e aguarda o commit que conterá este estado.
- Próximo passo exato: estender `IWorkflowStore` com comandos de start/pause/resume/cancel, avanço de objetivo, avaliação de gate e conclusão de fase; aplicar `expectedVersion`, Inbox, ledger e Outbox em cada mutação e reidratar a hierarquia completa e o progresso ponderado nos dois providers.
- Bloqueios: nenhum.
...
- Pipeline: `tools/backend/verify.sh` verde após inicialização EP-10b.2b.1: restore locked, format, build Release com zero warnings/erros e 84/84 testes verdes.
