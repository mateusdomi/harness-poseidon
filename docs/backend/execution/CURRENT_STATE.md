...
Atualizado em: 2026-07-18T21:20:00Z
...
- Pipeline: `tools/backend/verify.sh` verde após F2-WORK-1a: restore locked, format, build Release com zero warnings/erros e 125/125 testes verdes.
