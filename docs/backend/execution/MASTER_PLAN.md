...
10. EP-09b: migrations e store transacional dual-provider da cadeia — próximo incremento.
11. EP-10: WorkflowDefinition/Run, fases, gates e progresso objetivo.
12. Documentos/versionamento/aprovações, workers e SignalR persistido; então fechar formalmente a Fase 1/GNG-2.
