...
27. F1-WRK-1b: stores e dispatcher persistido dual-provider — próximo incremento.
28. Watchdog/reconciliador e SignalR persistido; então fechar formalmente a Fase 1/GNG-2.
