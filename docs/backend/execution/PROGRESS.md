...
| F2-DOGFOOD-1c reconciliação | próximo | reativar mailbox pendente/processing após expiração, rejeitar fencing antigo e limitar retries antes de compor claims/worktree/sandbox Docker |
