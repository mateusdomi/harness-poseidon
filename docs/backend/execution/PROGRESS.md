...
| F2-DOGFOOD-1d.2b composição externa | próximo | orquestrador tipado: claim persistente → branch/worktree exclusiva → sandbox Docker → `CodexCliAgentExecutor` → conclusão/cleanup/liberação com recovery |
