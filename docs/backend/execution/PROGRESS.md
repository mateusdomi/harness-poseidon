...
| F2-DOGFOOD-1d.2c recovery da composição | próximo | encerramento abrupto por estágio (pós-claim, pós-branch, pós-worktree, durante executor, pós-conclusão, cleanup parcial, liberação) com reclaim + compensação sem duplicar branch/worktree |
