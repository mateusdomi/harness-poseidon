...
| F2-DOGFOOD-1e dogfood externo | próximo | fiação DI + política de projeto externo, smoke classificado com Docker/Codex reais e pipeline dogfood completo solicitação→auditoria |
