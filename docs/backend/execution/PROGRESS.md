...
| F2-DOGFOOD-2b dogfood completo | próximo | cenário ponta a ponta solicitação→Chief→demanda→tarefa→execução isolada→critic/gate→auditoria; smoke com Codex real (`HARNESS_RUN_REAL_AGENT_TESTS=true`) |
