...
| F2-DOGFOOD-3 preparação GNG-3 | próximo | smoke com Codex real (`HARNESS_RUN_REAL_AGENT_TESTS=true`, modo docker, consome cota), E2E do frontend contra API real e homologação humana registrada — GNG-3 só com aceite humano |
