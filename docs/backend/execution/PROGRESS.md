...
| F2-DOGFOOD-2 dogfood completo | próximo | smoke com Codex real (`HARNESS_RUN_REAL_AGENT_TESTS=true`) e pipeline solicitação→Chief→tarefa→execução isolada→critic/gate→auditoria |
