...
| F2-DOGFOOD-1e.2 dogfood externo | próximo | fiação DI + política de projeto externo, smoke com Codex real (`HARNESS_RUN_REAL_AGENT_TESTS=true`) e pipeline dogfood completo solicitação→auditoria |
