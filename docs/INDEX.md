...
| Document | Phase | Status | Owner | Load policy | Tokens |
|---|---|---|---|---|---:|
| [DECISIONS — Frontend Harness Poseidon](frontend/DECISIONS.md) | * | Active | Frontend | OnDemand | 17258 |
| [HANDOFF — Camada de API do Frontend](frontend/HANDOFF_API.md) | * | Active | Frontend | OnDemand | 7592 |
...
| [SCREENS — Inventário de telas e auditoria de estados (FR-5)](frontend/SCREENS.md) | * | Active | Frontend | OnDemand | 4023 |
