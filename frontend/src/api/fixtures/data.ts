...
export function buildFixtures(seed: number = FIXTURE_SEED): FixtureData {
  ...
  const referenciasVisuais: VisualReference[] = [
    {
      ...
      imageUrl: 'https://cdn.poseidon.local/refs/kanban-denso.png',
      source: 'url',
    ...
    },
    {
      ...
      imageUrl: 'https://cdn.poseidon.local/refs/paleta-dark.png',
      source: 'upload',
      tags: ['tema', 'dark'],
      createdAt: tick(),
    },
    {
      ...
      imageUrl: 'https://cdn.poseidon.local/refs/cockpit-mock.png',
      source: 'generated',
      tags: ['cockpit'],
      createdAt: tick(),
    },
    {
      ...
      imageUrl: 'https://cdn.poseidon.local/refs/aprovacoes-figma.png',
      source: 'url',
  ...
  const data: FixtureData['data'] = {
    ...
    'agent-definitions': [defChefe, defBackend, defFrontend, defRevisor, defTestador, defDesigner],
    ...
    accounts: [accountOpenAI, accountAnthropic],
