  ...
  const approvals: Approval[] = [
    {
      ...
      businessTitle: 'Confirmar a qualidade da entrega',
      businessDescription: 'Revise os resultados das verificações e confirme se a entrega pode avançar.',
      priority: 'high',
    ...
    },
    {
      ...
      businessTitle: 'Aprovar a especificação da integração',
      businessDescription: 'Confirme se o documento representa corretamente a integração esperada.',
      priority: 'medium',
    ...
    },
    {
      ...
      businessTitle: 'Aprovar a publicação das verificações de ponta a ponta',
      businessDescription: 'Confirme se os resultados apresentados são suficientes para publicar esta entrega.',
      priority: 'critical',
    ...
    },
    {
      ...
      businessTitle: 'Aprovar o documento de produto do console',
      businessDescription: 'Confirme se o documento representa o resultado esperado para o console.',
      priority: 'medium',
      dueAt: null,
      state: 'approved',
      requestedByAgentId: chefePoseidon.id,
    ...
    },
    {
      ...
      businessTitle: 'Decidir sobre o aumento de capacidade mensal',
      businessDescription: 'Avalie se o aumento de capacidade é necessário antes de registrar a decisão.',
      priority: 'low',
      dueAt: null,
      state: 'rejected',
      requestedByAgentId: chefePoseidon.id,
