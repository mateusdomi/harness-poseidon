...
export function LeadershipProfileDialog({
  ...
  return (
    <ModalDialog
      label={t('orchestrator.profile.title')}
      onClose={onClose}
      className="max-w-3xl"
    >
      <form className="flex flex-col gap-5" onSubmit={(event) => void submit(event)}>
        <div>
          <h2 className="font-heading text-xl font-semibold">{t('orchestrator.profile.title')}</h2>
        ...
        {profileQuery.isLoading ? (
          ...
          <>
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <Field htmlFor="leadership-photo" label={t('orchestrator.profile.photo')}>
                <Input
                  id="leadership-photo"
                  type="file"
                  ...
                  onChange={(event) => {
                    ...
                    if (photo) uploadPhoto.mutate(photo);
                  }}
                />
              </Field>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <Field htmlFor="leadership-personality" label={t('orchestrator.profile.personality')}>
                <Textarea
        ...
        {error ? <p role="alert" className="text-sm text-error">{error.message}</p> : null}
