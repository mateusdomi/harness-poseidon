...
/**
 * Markdown compartilhado (chat, documentos) com destaque de código via
 * tokens do DS (bloco: superfície elevada + mono; inline: chip mono).
 * Links abrem em nova aba. Sem syntax highlighter pesado — ver DECISIONS (D-016).
 */
