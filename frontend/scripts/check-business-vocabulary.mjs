...
const FORBIDDEN = {
  'pt-BR': [
    ...
    [/\bIA\b/i, 'não apresente colaboradores como inteligência artificial'],
    [/\bLLMs?\b/i, 'não apresente colaboradores como modelos de linguagem'],
    [/\brobôs?\b/i, 'use "profissional", "colaborador" ou o cargo da pessoa'],
  ...
  en: [
    ...
    [/\bAI\b/i, 'do not present collaborators as artificial intelligence'],
    [/\bLLMs?\b/i, 'do not present collaborators as language models'],
    [/\brobots?\b/i, 'use "professional", "team member", or the person role'],
